...
class RegisterdDrugListTopView: UIView {
    ...
    func labelStringUpdate( valueString : String ) {
        ...
        let defaultAttribute = [
            NSAttributedStringKey.font : UIFont(name: Nanum_Barun_Gothic_OTF_Ultra_Light, size: 12)!,
            NSAttributedStringKey.foregroundColor : UIColor.black,
            NSAttributedStringKey.kern : -0.48 //자간?
            ] as! [NSAttributedStringKey : NSObject]
        let valueAttribute = [
            NSAttributedStringKey.font : UIFont(name: Nanum_Barun_Gothic_OTF_Bold, size: 12)!,
            NSAttributedStringKey.foregroundColor : UIColor(red: 221.0 / 255.0, green: 15.0 / 255.0, blue: 15.0 / 255.0, alpha: 1.0),
        ] as [NSAttributedStringKey : NSObject]
