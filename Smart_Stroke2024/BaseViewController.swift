...
//        managementTableView.reloadData()
        ...
        statusBar.backgroundColor = #colorLiteral(red: 0.0542004481, green: 0.2195232511, blue: 0.4927759171, alpha: 1)
        
        self.view.addSubview(statusBar)
        
        naviBar = UIView(frame: CGRect(x: 0, y: statusBar.frame.maxY, width: SCREEN.WIDTH, height: 50))
        naviBar.backgroundColor = #colorLiteral(red: 0.0542004481, green: 0.2195232511, blue: 0.4927759171, alpha: 1)
...
//        naviBarButton.addSubview(naviBarButtonImage)
        ...
        if IS_IPHONE_N {
            ...
            naviBarButton.backgroundColor = #colorLiteral(red: 0.05174487084, green: 0.2184319198, blue: 0.4917694926, alpha: 1)
            naviBarButtonImage = UIImageView(frame: CGRect(x: 0, y: 0, width: 25, height: 25))
...
//        smart.font = UIFont(name: NotoSansCJKkr_Medium, size: 2)
        ...
        button1 = UIButton(frame: CGRect(x: 0, y: 0, width: menuView.frame.size.width / 3, height: menuView.frame.height))
          button1.setTitle("", for: .normal)
          button1.backgroundColor = UIColor.white
          button1.translatesAutoresizingMaskIntoConstraints = false
//        button1.layer.borderWidth = 1
        button1.layer.cornerRadius = 8
        button1.addTarget(self, action: #selector(baseSegButtonPressed(_ :)), for: .touchUpInside)
        button1.tag = 0

        button2 = UIButton(frame: CGRect(x: 0, y: 0, width: menuView.frame.size.width / 3, height: menuView.frame.height))
          button2.setTitle("", for: .normal)
          button2.backgroundColor = UIColor.white
          button2.translatesAutoresizingMaskIntoConstraints = false
//        button2.layer.borderWidth = 1
        button2.layer.cornerRadius = 8
        button2.addTarget(self, action: #selector(baseSegButtonPressed(_ :)), for: .touchUpInside)
        button2.tag = 1

        button3 = UIButton(frame: CGRect(x: 0, y: 0, width: menuView.frame.size.width / 3, height: menuView.frame.height))
          button3.setTitle("", for: .normal)
          button3.backgroundColor = UIColor.white
          button3.translatesAutoresizingMaskIntoConstraints = false
        button3.addTarget(self, action: #selector(baseSegButtonPressed(_ :)), for: .touchUpInside)
...
//        buttonStackView.addSubview(buttonStackViewLabel)
        ...
        baseUnderBar = UIView(frame: CGRect(x: button1.center.x - 22, y: buttonStackView.frame.size.height - 2, width: SCREEN.WIDTH / 8.85, height: 2))
        baseUnderBar.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
                
                buttonStackView.addSubview(baseUnderBar)
//
//        
//        var myUnderBar = UIView(frame: CGRect(x: 10, y: buttonStackView.frame.height - 1, width: 20, height: 2))
//        myUnderBar.backgroundColor = .black
//        buttonStackView.addSubview(myUnderBar)
       
//        button1.layer.addBorder([.bottom], color: .black, width: 2)
...
//          labelOne.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 40).isActive = true
        ...
        func baseMoveSelected(view :UIView, button: UIButton) {
            if IS_IPHONE_N_PLUS{
                baseUnderBar.frame.origin.x = button.center.x - 20
            } else if IS_IPHONE_X {
                baseUnderBar.frame.origin.x = button.center.x - 18
...
//        
    ...
    @objc func baseSegButtonPressed(_ sender: UIButton) {
        print("tab")
        ...
        if sender.tag == 0 {
            UIView.animate(withDuration: 0.5, animations: { [self] in
                ...
                baseMoveSelected(view: baseUnderBar, button: button1)
            ...
            UIView.animate(withDuration: 0.5, animations: { [self] in
                ...
                baseMoveSelected(view: baseUnderBar, button: button2)
                
            })
        } else if sender.tag == 2 {
            UIView.animate(withDuration: 0.5, animations: { [self] in
                
                baseMoveSelected(view: baseUnderBar, button: button3)
