...
//import UIKit
//
//class DyslipidemiaViewController2: BaseViewController {
//    
...
//        
//        
//        let ProgressView = CircularProgressView(frame: CGRect(x: DyslipidemiaManagementNotebookView.DyslipidemiaVIewGraph.frame.size.width / 8, y: 10, width: 80, height: 80), lineWidth: 15, rounded: false)
//        
...
class DyslipidemiaViewController2: BaseViewController, UITextFieldDelegate {
...
//
//        } else if IS_IPHONE_N {
//            DyslipidemiaManagementNotebookView.DyslipidemiaVIewBTN = UIButton(frame: CGRect(x: 60, y: DyslipidemiaManagementNotebookView.DyslipidemiaVIewShowNumLabel.frame.maxY + 15, width: 90, height: DyslipidemiaManagementNotebookView.DyslipidemiahVIew.frame.size.height / 9))
//            
//        } else {
...
//            penBtnImageView = UIImageView(frame: CGRect(x: 9, y: 6, width: 10, height: 10))
//        } else if IS_IPHONE_N_PLUS {
//            penBtnImageView = UIImageView(frame: CGRect(x: 10, y: 5, width: 9, height: 9))
//        } else if IS_IPHONE_N {
...
//            
//        } else if IS_IPHONE_12PRO {
//            DyslipidemiaManagementNotebookView.DyslipidemiaVIewBTN = UIButton(frame: CGRect(x: 50, y: DyslipidemiaManagementNotebookView.DyslipidemiaVIewShowNumLabel.frame.maxY + 15, width: 115, height: DyslipidemiaManagementNotebookView.DyslipidemiahVIew.frame.size.height / 9.5))
//        } else {
//            DyslipidemiaManagementNotebookView.DyslipidemiaVIewBTN = UIButton(frame: CGRect(x: 50, y: DyslipidemiaManagementNotebookView.DyslipidemiaVIewShowNumLabel.frame.maxY + 15, width: 115, height: DyslipidemiaManagementNotebookView.DyslipidemiahVIew.frame.size.height / 9))
//        }
        if IS_IPHONE_N_PLUS {
...
////        }
////
//        saveData = UILabel(frame: CGRect(x: 20, y: DyslipidemiaManagementNotebookView.DyslipidemiahVIew.frame.maxY + 20, width: self.view.frame.size.width - 40, height: self.view.frame.size.height / 12))
//        saveData.text = "혈중 지질 수치를 입력해주세요."
//        saveData.font = UIFont(name: "SUITE-Regular", size: 18)
//        
//        
...
//        
////        hideView.backgroundColor = .lightGray
//        hideView.backgroundColor = #colorLiteral(red: 0.9328176975, green: 0.9423276186, blue: 0.9662449956, alpha: 1)
//        set.addSubview(hideView)
//        
//        var setTitle = UILabel(frame: CGRect(x: set.frame.size.width / 4, y: setImgView.frame.maxY, width: 300, height: 50))
//        setTitle.font = UIFont.systemFont(ofSize: 18)
