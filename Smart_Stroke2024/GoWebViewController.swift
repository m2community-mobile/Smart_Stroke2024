...
//        titleName.text = titleLabel
        ...
        titleName.widthAnchor.constraint(equalToConstant: 170).isActive = true
        ...
        if titleLabel == UserDefaults.standard.string(forKey: "stroke") {
            ...
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "hyperlipidemia") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "fibrillation") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "smoke") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "drink") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "obesity") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "first") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "strokeTreatment") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "thrombolysis") {
            titleName.text = titleLabel
        } else if titleLabel == UserDefaults.standard.string(forKey: "medication") {
            titleName.text = titleLabel
            
        } else if titleLabel == UserDefaults.standard.string(forKey: "risk") {
            titleName.text = titleLabel
            
        } else if titleLabel == UserDefaults.standard.string(forKey: "tos") {
            titleName.text = titleLabel
            
        }  else if titleLabel == UserDefaults.standard.string(forKey: "eatt") {
            titleName.text = titleLabel
            
        }else if titleLabel == UserDefaults.standard.string(forKey: "fat") {
            titleName.text = titleLabel
            
        }else if titleLabel == UserDefaults.standard.string(forKey: "del") {
            titleName.text = titleLabel
            
        }else if titleLabel == UserDefaults.standard.string(forKey: "sad") {
            titleName.text = titleLabel
            
        }else if titleLabel == UserDefaults.standard.string(forKey: "nursing") {
            titleName.text = titleLabel
            
        } else if titleLabel == UserDefaults.standard.string(forKey: "pm") {
            titleName.text = titleLabel
...
//        naviBarButton.addSubview(naviBarButtonImage)
        ...
        if IS_IPHONE_N {
            ...
            naviBarButton = UIButton(frame: CGRect(x: naviBar.frame.maxX - 55, y: naviBar.frame.size.height / 5, width: 25, height: 25))
            naviBarButton.backgroundColor = #colorLiteral(red: 0.04269760102, green: 0.2185101509, blue: 0.4917834401, alpha: 1)
            naviBarButtonImage = UIImageView(frame: CGRect(x: 0, y: 0, width: 25, height: 25))
