...
extension UIScrollView {
    func updateContentSize() {
        ...
        // 계산된 크기로 컨텐츠 사이즈 설정
        self.contentSize = CGSize(width: self.frame.width, height: unionCalculatedTotalRect.height+300)
    }
...
//        iconViewiconContainerView.contentMode = .scaleAspectFit
       iconView.image = image
       let iconContainerView: UIView = UIView(frame:
                      CGRect(x: 30, y: 5, width: 30, height: 30))
