...
//import UIKit
//
//class ObesityViewController3: BaseViewController {
//    
...
//            width: SCREEN.WIDTH,
//            height: SCREEN.HEIGHT - menuView.frame.maxY), urlString: "https://www.google.com")
//        
...
//        
//        
//        ObesityManagementNotebookView.bmiGraphVIew = UIView(frame: CGRect(x: 0, y: scrollView.frame.minY, width: self.view.frame.size.width, height: self.view.frame.size.height / 5))
...
//        
//        ObesityManagementNotebookView.bmiGraphVIewLabel = UILabel(frame: CGRect(x: self.view.frame.size.width / 5, y: ObesityManagementNotebookView.bmiGraphVIew.frame.minY, width: self.view.frame.size.width / 3, height: ObesityManagementNotebookView.bmiGraphVIew.frame.size.height / 2))
...
//        
//        ObesityManagementNotebookView.bmiGraphVIewShowLabel = UILabel(frame: CGRect(x: self.view.frame.size.width / 5.4, y: ObesityManagementNotebookView.bmiGraphVIewLabel.frame.maxY + 10, width: self.view.frame.size.width / 2, height: ObesityManagementNotebookView.bmiGraphVIew.frame.size.height / 2))
...
//        ObesityManagementNotebookView.bmiGraphVIewShowLabel.font = UIFont.systemFont(ofSize: 25)
//        
//        ObesityManagementNotebookView.bmiGraphVIew.addSubview(ObesityManagementNotebookView.bmiGraphVIewShowLabel)
//        
//        ObesityManagementNotebookView.bmiGraphVIewShowNumLabel = UILabel(frame: CGRect(x: ObesityManagementNotebookView.bmiGraphVIewLabel.frame.maxX + 5, y: ObesityManagementNotebookView.bmiGraphVIew.frame.minY, width: self.view.frame.size.width / 2.5, height: ObesityManagementNotebookView.bmiGraphVIew.frame.size.height / 2))
//        ObesityManagementNotebookView.bmiGraphVIewShowNumLabel.text = "목표 수치 달성율은?"
...
//        
//        
//        ObesityManagementNotebookView.bmiGraphVIewGraph = UIView(frame: CGRect(x: ObesityManagementNotebookView.bmiGraphVIewLabel.frame.maxX + 5, y: ObesityManagementNotebookView.bmiGraphVIewShowNumLabel.frame.maxY + 1, width: self.view.frame.size.width / 2.8, height: ObesityManagementNotebookView.bmiGraphVIew.frame.size.height / 2))
//        ObesityManagementNotebookView.bmiGraphVIewGraph.backgroundColor = .white
//        
...
//        
//        
//        ObesityManagementNotebookView.dateLable = UILabel(frame: CGRect(x: dateViewLabel.frame.maxX + 130, y: dateViewLabel.frame.minY, width: 200, height: dateView.frame.height))
...
//        
//        bmiCheck = UIButton(frame: CGRect(x: 20, y: myWeightView.frame.maxY + 5,  width: saveView.frame.size.width - 40, height: self.view.frame.size.height / 12))
...
//        
//        
//        ObesityManagementNotebookView.bmiGraphVIewGraph = UIView(frame: CGRect(x: ObesityManagementNotebookView.bmiGraphVIewLabel.frame.maxX + 5, y: ObesityManagementNotebookView.bmiGraphVIewShowNumLabel.frame.maxY, width: self.view.frame.size.width / 3.5, height: ObesityManagementNotebookView.bmiGraphVIew.frame.size.height / 2))
...
//        
//        
//        let ProgressView = CircularProgressView(frame: CGRect(x: ObesityManagementNotebookView.bmiGraphVIewGraph.frame.size.width / 8, y: 0, width: 80, height: 80), lineWidth: 15, rounded: false)
//        
...
class ObesityViewController3: BaseViewController, UITextFieldDelegate {
...
//        } else if IS_IPHONE_X {
//            ObesityManagementNotebookView.bmiGraphVIewShowNumLabel.font = UIFont(name: "SUITE-Regular", size: 15)
//        } else {
//            ObesityManagementNotebookView.bmiGraphVIewShowNumLabel.font = UIFont(name: "SUITE-Regular", size: 17)
//        }
//        
...
//        graphLabel = UILabel(frame: CGRect(x: 20, y: bmiCheck.frame.maxY + 30, width: SCREEN.WIDTH - 40, height: 32))
//        graphLabel.text = "BMI (체질량지수) 는\n 00으로 00입니다."
//        graphLabel.numberOfLines = 0
//        graphLabel.textAlignment = .center
//        graphLabel.font = UIFont(name: "SUITE-Regular", size: 15)
...
//        graph.isHidden = true
//        graph.image = UIImage(named: "test001")
//        graph.alpha = 1
...
//        myView.backgroundColor = .clear
        ...
        graph = UIImageView(frame: CGRect(x: 20, y: graphLabel.frame.maxY + 10, width: SCREEN.WIDTH - 80, height: 180))
...
//        graph.addSubview(myView)
         ...
         gymSaveData = UILabel(frame: CGRect(x: 20, y: saveView.frame.maxY + 2, width: self.view.frame.size.width - 40, height: self.view.frame.size.height / 14))
        gymSaveData.text = "운동 시간을 입력해주세요."
        saveData.font = UIFont(name: "SUITE-Regular", size: 18)
//        gymSaveData.font = UIFont.systemFont(ofSize: 18)
