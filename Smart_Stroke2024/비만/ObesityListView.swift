...
class ObesityListView: UIView {
            ...
            ,WMY_ChangeViewDelegate
        {
            ...
            override init(frame: CGRect) {
                ...
                ////그래프
                graphView = KJG_GraphView(frame: CGRect(x: 15, y: wmy_ChangeView.frame.maxY, width: SCREEN.WIDTH - 30, height: 320),
                                          type: .line,
                                          numberOfGraph: 1)
...
//                self.graphView.setRedLineValues(values: [23,18.5])
                ...
                //10
                let valueInfoView = UIView(frame: CGRect(x: 15, y: graphView.frame.maxY - 15, width: SCREEN.WIDTH - 30, height: 20))
...
//                }
            ...
            func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
                ...
                cell.cellComponentViews[4].valueLabel.font = UIFont(name: "SUITE-Bold", size: 19)
                if IS_IPHONE_N {
                    cell.cellComponentViews[4].valueLabel.font = UIFont(name: "SUITE-Bold", size: 15)
                }
