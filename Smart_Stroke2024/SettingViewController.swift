...
//        changeMyInfo.titleLabel?.font = UIFont(name: "SUITE-Regular", size: 16)
        changeMyInfo.titleLabel?.font = UIFont(name: "SUITE-Bold", size: 16)
        ...
        if IS_IPHONE_X {
            ...
            changeMyInfo.imageEdgeInsets = UIEdgeInsets(top: 0, left: 230, bottom: 0, right: 0)
        } else {
...
//        changePW.titleLabel?.font = UIFont(name: "SUITE-Regular", size: 16)
        changePW.titleLabel?.font = UIFont(name: "SUITE-Bold", size: 16)
        ...
        if IS_IPHONE_X {
            ...
            changePW.imageEdgeInsets = UIEdgeInsets(top: 0, left: 230, bottom: 0, right: 0)
        } else {
...
//        self.view.addSubview(separatorView1)
        ...
        let noticeView1 = ViewTextType(frame: CGRect(x: 20, y: changePW.frame.maxY + 10, width: SCREEN.WIDTH, height: 300), text: noticeView1Text, fontSize: viewTextTypeFontSize)
        noticeView1.textLabel.font = UIFont(name: "SUITE-Regular", size: 16)
        noticeView1.textLabel.font = UIFont(name: "SUITE-Medium", size: 16)
        ...
        noticeView2.textLabel.font = UIFont(name: "SUITE-Regular", size: 16)
...
//        testButton.addTarget(self, action: #selector(go(_ :)), for: .touchUpInside)
    ...
    @objc func logout(_ sender: UIButton) {
        ...
        UserDefaults.standard.setValue("0", forKey: "persent")
        UserDefaults.standard.setValue(0, forKey: "perGraph")
        
        UserDefaults.standard.setValue("정상", forKey: "how")
        UserDefaults.standard.setValue(0, forKey: "neddle")
        
        
//        UserDefaults.standard.setValue(00, forKey: "sh")
        UserDefaults.standard.removeObject(forKey: "sh")
//        UserDefaults.standard.setValue(00, forKey: "re")
        UserDefaults.standard.removeObject(forKey: "re")
//        UserDefaults.standard.setValue(00, forKey: "ch")
        UserDefaults.standard.removeObject(forKey: "ch")
        
        UserDefaults.standard.setValue("0", forKey: "persenS1")
        UserDefaults.standard.setValue(0, forKey: "perGraphS1")
        UserDefaults.standard.setValue("0", forKey: "persenS2")
        UserDefaults.standard.setValue(0, forKey: "perGraphS2")
        UserDefaults.standard.setValue("0", forKey: "persenS3")
        UserDefaults.standard.setValue(0, forKey: "perGraphS3")
        
        UserDefaults.standard.setValue("0", forKey: "persentB")
        UserDefaults.standard.setValue(0, forKey: "perGraphB")
        
        UserDefaults.standard.setValue("0", forKey: "persentD")
        UserDefaults.standard.setValue(0, forKey: "perGraphD")
        
        
        UserDefaults.standard.setValue(0, forKey: "key")
        UserDefaults.standard.setValue(0, forKey: "DyKey")
        
        UserDefaults.standard.removeObject(forKey: "numtf")
...
//        print("logout: \(UserDefaults.standard.set(false, forKey: "password"))")
    }
...
//                            
//                            
//                            if let fbemail = (data as AnyObject)["email1"]! as? String
//                            {
//                               print("-->\(fbemail)")
//                            }
...
//        textLabel.font = UIFont(name: Nanum_Barun_Gothic_OTF, size: 17)!
        ...
        textLabel.textColor = #colorLiteral(red: 0.4077255726, green: 0.4077255428, blue: 0.4077255726, alpha: 1)
        textLabel.text = text
...
//        itemLabel.font = UIFont(name: "SUITE-Regular", size: 16)
        itemLabel.font = UIFont(name: "SUITE-Medium", size: 16)
        
        
        itemLabel.font = UIFont(name: "SUITE-Bold", size: 16)
...
class ViewAppVersionType: UIView {
    ...
    init(itemName : String, tintColor : UIColor) {
        ...
        currentVersionLabel.textColor = #colorLiteral(red: 0.6280127764, green: 0.6587793231, blue: 0.7174302936, alpha: 1)
//        currentVersionLabel.font = UIFont(name: Nanum_Barun_Gothic_OTF, size: 15)
//        currentVersionLabel.font = UIFont(name: "SUITE-Regular", size: 16)
        
        currentVersionLabel.font = UIFont(name: "SUITE-Medium", size: 16)
        
        currentVersionLabel.font = UIFont(name: "SUITE-Bold", size: 16)
...
//        updateButton.layer.borderColor = mainColor.cgColor
        ...
        updateButton.setTitleColor(#colorLiteral(red: 0.3227340579, green: 0.3460992575, blue: 0.3958329856, alpha: 1), for: .normal)
        updateButton.titleLabel?.font = UIFont(name: "SUITE-Regular", size: 16)
        
        updateButton.titleLabel?.font = UIFont(name: "SUITE-Medium", size: 16)
