...
class RegisterdDrugListView3: UIView
...
//    var drugManagementVC : DrugManagementViewController?
   ...
   //2
    var drugManagementVC : MedicationManagementViewController3?
...
@objc protocol RegisterdDrugListTopViewDelegate3 {
    @objc optional func addButtonPressed( button : UIButton )
}


// 한달간 복약 라벨 뷰
class RegisterdDrugListTopView3: UIView {
...
//        self.backgroundColor = .yellow
        ...
        let myImage = UIImageView(frame: CGRect(x: self.frame.size.width / 2.3, y: 30, width: 50, height: 50))
