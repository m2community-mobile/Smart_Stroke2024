...
class RegisterdDrugListView2: UIView
...
//    var drugManagementVC : DrugManagementViewController?
   ...
   //2
    var drugManagementVC : MedicationManagementViewController2?
...
@objc protocol RegisterdDrugListTopViewDelegate2 {
    @objc optional func addButtonPressed( button : UIButton )
}


// 한달간 복약 라벨 뷰
class RegisterdDrugListTopView2: UIView {
