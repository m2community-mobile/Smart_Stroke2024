...
//
//
//class BloodSugarViewController: BaseViewController {
//
...
//            BloodSugarRecordsView.isHidden = true
//        } else if sender.tag == 1 {
//            BloodSugarWebView.isHidden = true
//            BloodSugarManagementNotebookView.isHidden = false
//            BloodSugarRecordsView.test.isHidden = true
//        } else if sender.tag == 2 {
//            BloodSugarWebView.isHidden = true
//            BloodSugarManagementNotebookView.isHidden = true
//            BloodSugarRecordsView.test.isHidden = false
//        }
//    }
//
//
...
class HalfCircleProgressView: UIView {
    ...
    private func commonInit() {
        ...
        backgroundLayer.strokeColor = UIColor.white.withAlphaComponent(0.5).cgColor //  뒷배경 색
        backgroundLayer.cornerRadius = 12
        backgroundLayer.lineCap = .round
        
        
//        myView.backgroundColor = UIColor.white.withAlphaComponent(0.3)
        foregroundLayer.strokeColor = UIColor.white.cgColor // 움직이는 그래프 색
        foregroundLayer.cornerRadius = 12
        foregroundLayer.lineCap = .round
        
        ticksLayer.strokeColor = UIColor.white.withAlphaComponent(0).cgColor// 사이 배경
...
class HalfCircleProgressView2: UIView {
    ...
    private func commonInit() {
        ...
        backgroundLayer.strokeColor = UIColor.white.withAlphaComponent(0.5).cgColor//  반원 뒷 배경
        backgroundLayer.lineCap = .round
//        myView.backgroundColor = UIColor.white.withAlphaComponent(0.3)
        foregroundLayer.strokeColor = UIColor.white.cgColor // 색칠되는 배경
        foregroundLayer.lineCap = .round
        ticksLayer.strokeColor = UIColor.white.withAlphaComponent(0).cgColor// 사이 배경
...
class HalfCircleProgressView3: UIView {
...
class BloodSugarViewController: BaseViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        //
        //                    container.leadingAnchor.constraint(equalTo: BloodSugarManagementNotebookView.FastingBloodSugar.leadingAnchor, constant: 20.0),
        //                    container.trailingAnchor.constraint(equalTo: BloodSugarManagementNotebookView.FastingBloodSugar.trailingAnchor, constant: -20.0),
        //                    container.heightAnchor.constraint(equalTo: container.widthAnchor, multiplier: 0.6),
        //                    container.centerYAnchor.constraint(equalTo: BloodSugarManagementNotebookView.FastingBloodSugar.centerYAnchor),
        //
        ...
        //        BloodSugarManagementNotebookView.FastingBloodSugar.layer.cornerRadius = 8
        //
        //        BloodSugarManagementNotebookView.FastingBloodSugar.layer.cornerRadius = 50
        ...
        //                NSLayoutConstraint.activate([
        //
        //            container.leadingAnchor.constraint(equalTo: BloodSugarManagementNotebookView.FastingBloodSugar.leadingAnchor, constant: 100.0),
        //            container.trailingAnchor.constraint(equalTo: BloodSugarManagementNotebookView.FastingBloodSugar.trailingAnchor, constant: -100.0),
        //            container.heightAnchor.constraint(equalTo: container.widthAnchor, multiplier: 0.6),
        //            container.centerYAnchor.constraint(equalTo: BloodSugarManagementNotebookView.FastingBloodSugar.centerYAnchor),
        //
        //            // let's inset our progress view by 40-points on each side
...
//          }
        ...
        slayer.add(animation, forKey: nil)
          ...
          showLabel = UILabel(frame: CGRect(x: 40, y: 80, width: 50, height: 30))
          if IS_IPHONE_N_PLUS {
              showLabel = UILabel(frame: CGRect(x: 40, y: 60, width: 50, height: 30))
          } else if IS_IPHONE_12PRO {
