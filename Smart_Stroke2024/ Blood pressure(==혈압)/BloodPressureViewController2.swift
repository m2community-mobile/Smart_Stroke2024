...
//import UIKit
//
//class BloodPressureViewController2: BaseViewController {
//    
...
class BloodPressureViewController2: BaseViewController, UITextFieldDelegate {
...
//        self.present(vc, animated: false)
//
        NotificationCenter.default.post(name: Notification.Name("editTest"), object: nil, userInfo: nil)
...
//        if contractionInputView.text!.toInt()! < 90 || contractionInputView.text!.toInt()! > 999 {
...
//extension BloodPressureViewController2: UITextFieldDelegate {
//
//func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
//
...
//    }
//
//    if let newValue = textField.text?.toInt(), let currentValue = string.toInt() {
