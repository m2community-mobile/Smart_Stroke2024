...
class BloodPressureViewController: BaseViewController, UITextFieldDelegate {
...
//        UnderBar = UIView(frame: CGRect(x: button1.center.x - 20 , y: button1.frame.size.height - 2, width: button1.frame.size.width / 3, height: 2))
//        UnderBar.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
//        
//        button1.addSubview(UnderBar)
...
//        var glycated: UITextField!
        ...
        saveView = UIView(frame: CGRect(x: 20, y: saveData.frame.maxY + 5, width: self.view.frame.size.width - 40, height: self.view.frame.size.height / 2.5))
...
//            dateViewLabel.isHidden = true
        ...
        if UserDefaults.standard.objectIsForced(forKey: "sh") != nil {
        goalCancelBTN.addTarget(self, action: #selector(can(_ :)), for: .touchUpInside)
            }
...
//            goalCancelBTN.addTarget(self, action: #selector(setDown(_ :)), for: .touchUpInside)
 ...
 print("-----------")
       print(UserDefaults.standard.object(forKey: "suc"))
        print("-----------")
...
//        scrollView.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true
//        scrollView.bottomAnchor.constraint(equalTo: cancelBTN.bottomAnchor, constant: 300).isActive = true
...
//        UnderBar.center.x = button.center.x + 5
//    }
    ...
    @objc func can(_ button: UIButton) {
...
//        
//        
////        let vc = BloodPressureViewController3()
////       
////                                                                   vc.modalPresentationStyle = .fullScreen
////                                                                   self.present(vc, animated: false)
//        let vc = BloodPressureViewController2()
...
//        labelTwo.bottomAnchor.constraint(equalTo: scrollView.bottomAnchor, constant: -40).isActive = true
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.bloodPressureListView.graphScrollView.setNeedsLayout()
        self.bloodPressureListView.graphScrollView.setNeedsDisplay()
        var time = Date()
        var formatter = DateFormatter()
        //        formatter.dateFormat = "MM.dd.yyyy a h:mm"
        formatter.locale = Locale(identifier: "ko_KR")
...
//    }
    ...
    {
        //post data
        let url = "http://strokedb.or.kr/app_new/blood_user.asp"
...
//                    "reg_num" : ""]
        ...
        let para = ["user_sid":"\(UserDefaults.standard.object(forKey: "userSid") ?? 0)"]
            ...
            .responseJSON { [self] response in
                ...
                case .success(let suc):
                    ...
                    do {
                        ...
                        let json = try decoder.decode(Bp.self, from: result)
                        ...
                        UserDefaults.standard.setValue(json.cnt, forKey: "cntV")
                        UserDefaults.standard.setValue(json.success, forKey: "sucV")
                        
//                        let persent = Int(round((Double(json.cnt)! / Double(json.success!)!) * 100))
                        print("-----")
...
//
//
//class BloodPressureViewController: BaseViewController, SegmentedViewDelegate {
//    
//    
//    
//    
...
//        segView.frame.origin.y = naviBar.frame.maxY
...
////            showLabel.text = UserDefaults.standard.string(forKey: "perB")
//        } else if IS_IPHONE_N_PLUS {
//            showLabel = UILabel(frame: CGRect(x: 35, y: 19, width: 42, height: 30))
//            
//            
//            
...
//        
//        if IS_IPHONE_N_PLUS {
//            BloodPressureManagementNotebookView.BloodPressureViewBTN = UIButton(frame: CGRect(x: 60, y: BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel2.frame.maxY + 15, width: 100, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 10))
////            BloodPressureManagementNotebookView.BloodPressureViewBTN.titleLabel?.font = UIFont(name: "SUITE-Regular", size: 17)
//        } else {
//            BloodPressureManagementNotebookView.BloodPressureViewBTN = UIButton(frame: CGRect(x: 50, y: BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel2.frame.maxY + 15, width: 115, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 10))
////            BloodPressureManagementNotebookView.BloodPressureViewBTN.titleLabel?.font = UIFont(name: "SUITE-Regular", size: 22)
...
//        mypulseView.addSubview(heartRateInputView)
//        
//        var dangerBTN = UIButton(frame: CGRect(x: 20, y: mypulseView.frame.maxY + 5, width: dateView.frame.size.width - 20, height: dateView.frame.height))
//        dangerBTN.setTitle("자가 혈압측정 시 주의사항", for: .normal)
//        dangerBTN.titleLabel?.font = UIFont(name: "SUITE-Regular", size: 17)
...
//        if IS_IPHONE_N_PLUS {
//            
//            dangerBTN2 = UIButton(frame: CGRect(x: 20, y: pulseGoal.frame.maxY + 15, width: dateView.frame.size.width - 20, height: 38))
//        } else if IS_IPHONE_12PRO_MAX {
//            dangerBTN2 = UIButton(frame: CGRect(x: 20, y: pulseGoal.frame.maxY + 25, width: dateView.frame.size.width - 20, height: 45))
//        } else if IS_IPHONE_X {
//            dangerBTN2 = UIButton(frame: CGRect(x: 20, y: pulseGoal.frame.maxY + 15, width: dateView.frame.size.width - 20, height: 40))
//        } else {
//            dangerBTN2 = UIButton(frame: CGRect(x: 20, y: pulseGoal.frame.maxY + 15, width: dateView.frame.size.width - 20, height: 38))
//        }
////        dangerBTN2 = UIButton(frame: CGRect(x: 20, y: pulseGoal.frame.maxY + 15, width: dateView.frame.size.width - 20, height: 35))
...
//        self.dataUpdate()
//        
//        let isBloodPressureNoteViewHidden = self.BloodPressureManagementNotebookView.isHidden
//        
//        self.BloodPressureWebView.isHidden = true
//        self.BloodPressureManagementNotebookView.isHidden = true
...
////                self.BloodPressureWebView.relaxtionInputView.valueTextField.text = ""
////                self.BloodPressureManagementNotebookView.contractionInputView.valueTextField.text = ""
////                self.BloodPressureManagementNotebookView.heartRateInputView.valueTextField.text = ""
//            }
//            self.BloodPressureManagementNotebookView.isHidden = false
//        }else if index == 2{
