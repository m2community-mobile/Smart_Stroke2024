...
//import UIKit
//
//class BloodPressureViewController3: BaseViewController {
//    
...
//        
//        
//        BloodPressureManagementNotebookView.BloodPressureView = UIView(frame: CGRect(x: 0, y: scrollView.frame.minY, width: self.view.frame.size.width, height: self.view.frame.size.height / 5))
...
//        
//        BloodPressureManagementNotebookView.BloodPressureVewLabel = UILabel(frame: CGRect(x: 35, y: BloodPressureManagementNotebookView.BloodPressureView.frame.minY + 20, width: self.view.frame.size.width / 2, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 5))
//        BloodPressureManagementNotebookView.BloodPressureVewLabel.text = "나의 혈압 목표 수치는?"
...
//        BloodPressureManagementNotebookView.BloodPressureVewLabel.font = UIFont.systemFont(ofSize: 17)
//        
...
//        
//        
//        BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel1 = UILabel(frame: CGRect(x: 35, y: BloodPressureManagementNotebookView.BloodPressureVewLabel.frame.maxY + 2, width: self.view.frame.size.width / 2, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 5))
//        BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel1.text = "수축기 120mg/dL"
//        BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel1.textColor = .white
//        BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel1.font = UIFont.systemFont(ofSize: 22)
//
...
//        BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel2.text = "이완기 120mg/dL"
...
//        
//        BloodPressureManagementNotebookView.BloodPressureViewShowLabel = UILabel(frame: CGRect(x: BloodPressureManagementNotebookView.BloodPressureVewLabel.frame.maxX + 5, y: BloodPressureManagementNotebookView.BloodPressureView.frame.minY + 20, width: self.view.frame.size.width / 2.5, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 5))
//        BloodPressureManagementNotebookView.BloodPressureViewShowLabel.text = "목표 수치 달성율은?"
//        BloodPressureManagementNotebookView.BloodPressureViewShowLabel.textColor = .white
//        BloodPressureManagementNotebookView.BloodPressureViewShowLabel.font = UIFont.systemFont(ofSize: 17)
//
...
//        
//        
//        BloodPressureManagementNotebookView.BloodPressureVewGraph = UIView(frame: CGRect(x: BloodPressureManagementNotebookView.BloodPressureVewLabel.frame.maxX + 5, y: BloodPressureManagementNotebookView.BloodPressureViewShowLabel.frame.maxY + 1, width: self.view.frame.size.width / 2.8, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 2))
//        BloodPressureManagementNotebookView.BloodPressureVewGraph.backgroundColor = .white
//
...
//        
//        BloodPressureManagementNotebookView.BloodPressureViewBTN = UIButton(frame: CGRect(x: 35, y: BloodPressureManagementNotebookView.BloodPressureViewShowNumLabel2.frame.maxY + 2, width: self.view.frame.size.width / 3, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 5))
...
//        
//        
//        BloodPressureManagementNotebookView.dateLable = UILabel(frame: CGRect(x: dateViewLabel.frame.maxX + 130, y: dateViewLabel.frame.minY, width: 200, height: dateView.frame.height))
...
//        
//        
//        BloodPressureManagementNotebookView.BloodPressureVewGraph = UIView(frame: CGRect(x: BloodPressureManagementNotebookView.BloodPressureVewLabel.frame.maxX + 5, y: BloodPressureManagementNotebookView.BloodPressureViewShowLabel.frame.maxY + 15, width: self.view.frame.size.width / 2.8, height: BloodPressureManagementNotebookView.BloodPressureView.frame.size.height / 2))
...
//        
//        
//        let ProgressView = CircularProgressView(frame: CGRect(x: BloodPressureManagementNotebookView.BloodPressureVewGraph.frame.size.width / 8, y: 0, width: 80, height: 80), lineWidth: 15, rounded: false)
//        
...
//        
//        
//        BloodPressureManagementNotebookView.dateLable = UILabel(frame: CGRect(x: dateViewLabel.frame.maxX + 100, y: dateViewLabel.frame.minY, width: 200, height: dateView.frame.height))
//        BloodPressureManagementNotebookView.dateLable.text = formattedDateInString
//        
//        
//        dateView.addSubview(BloodPressureManagementNotebookView.dateLable)
...
//        let dayweek = "1"
//        let day = "04"
//        let dateTime = "2024.02.04 a 01:00"
////
//        let sendDataDic = [
...
class BloodPressureViewController3: BaseViewController, UITextFieldDelegate {
...
//        if testBtn1.isSelected == true {
//            testBtn1.backgroundColor = #colorLiteral(red: 0, green: 0.5938842893, blue: 0.8105072379, alpha: 1)
//            testBtn2.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
//            
//        } else {
...
//        }
//        
//        if testBtn2.isSelected == true {
//            testBtn2.backgroundColor = #colorLiteral(red: 0, green: 0.5938842893, blue: 0.8105072379, alpha: 1)
//            testBtn1.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
//        } else {
//            testBtn1.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
//            testBtn2.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
...
//        contractionInputView.layer.borderWidth = 1
        ...
        contractionInputView.delegate = self
        mysystoleView.addSubview(contractionInputView)
...
//        relaxtionInputView = UITextField(frame: CGRect(x: mysystoleViewLabel.frame.maxX + 80, y: 0, width: mysystoleViewLabel.frame.width * 2, height: mysystoleViewLabel.frame.height))
        ...
        relaxtionInputView.font = UIFont(name: "SUITE-Regular", size: 17)
            relaxtionInputView.delegate = self
        mydiastoleView.addSubview(relaxtionInputView)
...
//        heartRateInputView = UITextField(frame: CGRect(x: mysystoleViewLabel.frame.maxX + 80, y: 0, width: mysystoleViewLabel.frame.width * 2, height: mysystoleViewLabel.frame.height))
        ...
        heartRateInputView.font = UIFont(name: "SUITE-Regular", size: 17)
            heartRateInputView.delegate = self
        mypulseView.addSubview(heartRateInputView)
...
//            penBtnImageView = UIImageView(frame: CGRect(x: 9, y: 9, width: 10, height: 10))
//        } else if IS_IPHONE_N_PLUS {
//            penBtnImageView = UIImageView(frame: CGRect(x: 7, y: 8, width: 10, height: 10))
//        } else if IS_IPHONE_N {
//            penBtnImageView = UIImageView(frame: CGRect(x: 8, y: 7, width: 8, height: 8))
//        } else if IS_IPHONE_12PRO_MAX {
//            penBtnImageView = UIImageView(frame: CGRect(x: 8, y: 10, width: 10, height: 10))
...
//        set.addSubview(pulseGoal)
        ...
        if IS_IPHONE_N_PLUS {
            ...
            dangerBTN2 = UIButton(frame: CGRect(x: 20, y: relaxation.frame.maxY + 15, width: dateView.frame.size.width - 20, height: 35))
            //            var btnImageView = UIImageView(frame: CGRect(x: 70, y: 13, width: 18, height: 18))
            //            if IS_IPHONE_12PRO {
...
//    override func viewDidAppear(_ animated: Bool) {
//        UnderBar = UIView(frame: CGRect(x: button3.center.x - 20 , y: button3.frame.size.height - 2, width: button1.frame.size.width / 3, height: 2))
//        UnderBar.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
//        
//        button3.addSubview(UnderBar)
//    }
...
//        bloodPressureListView.isHidden = true
    ...
    @objc func saveData(_ sender: UIButton) {
        ...
        if self.contractionInputView.text == "" {
            showToast(message: "수축기를 입력하세요.", font: UIFont(name: "SUITE-Regular", size: 20)!)

            
            return
        }
        if self.contractionInputView.text!.toInt()! < 90 {
            showToast(message: "최소 90이상을 입력하세요.", font: UIFont(name: "SUITE-Regular", size: 18)!)
            return
        }
        
        if self.relaxtionInputView.text == "" {
//            toastShow(message: "이완기를 입력하세요.")
            showToast(message: "이완기를 입력하세요.", font: UIFont(name: "SUITE-Regular", size: 20)!)
            return
        }
        if self.relaxtionInputView.text!.toInt()! < 50 {
            showToast(message: "최소 50이상을 입력하세요.", font: UIFont(name: "SUITE-Regular", size: 18)!)
            return
        }
        ...
        if self.heartRateInputView.text == "" {
//            toastShow(message: "맥박을 입력하세요.")
            showToast(message: "맥박을 입력하세요.", font: UIFont(name: "SUITE-Regular", size: 20)!)
            return
        }
//
        let max = self.contractionInputView.text!
...
//        NotificationCenter.default.post(name: NSNotification.Name("goal2"), object: nil, userInfo: nil)
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        if textField == contractionInputView {
            
            guard let textFieldText = contractionInputView.text,
        ...
        }else if textField == ShrinkGoal {
            
            guard let textFieldText = ShrinkGoal.text,
                  let rangeOfTextToReplace = Range(range, in: textFieldText) else {
                return false
            }
            let substringToReplace = textFieldText[rangeOfTextToReplace]
        ...
        }else if textField == relaxationGoal {
            
            guard let textFieldText = relaxationGoal.text,
                  let rangeOfTextToReplace = Range(range, in: textFieldText) else {
                return false
            }
            let substringToReplace = textFieldText[rangeOfTextToReplace]
