...
//        BloodSugarManagementNotebookView.FastingBloodSugarLabel.layer.borderWidth = 1
        ...
        if IS_IPHONE_X {
            BloodSugarManagementNotebookView.FastingBloodSugarLabel.font = UIFont.systemFont(ofSize: 14)
     ...
     BloodSugarManagementNotebookView.FastingBloodSugarShowLabel.text = "금식혈당\n(Fasting glucose)"
        ...
        if IS_IPHONE_N_PLUS {
            BloodSugarManagementNotebookView.FastingBloodSugarShowLabel.font = UIFont.systemFont(ofSize: 11)
        ...
        if IS_IPHONE_X {
            BloodSugarManagementNotebookView.FastingBloodSugarShowNumLabelNumber.font = UIFont.systemFont(ofSize: 20)
     ...
     BloodSugarManagementNotebookView.FastingBloodSugarShowNumLabel.text = "mg/dL\n이하"
        ...
        if IS_IPHONE_X {
            BloodSugarManagementNotebookView.FastingBloodSugarShowNumLabel.font = UIFont.systemFont(ofSize: 10)
        ...
        if IS_IPHONE_X {
            BloodSugarManagementNotebookView.FastingBloodSugarPercent.font = UIFont.systemFont(ofSize: 14)
