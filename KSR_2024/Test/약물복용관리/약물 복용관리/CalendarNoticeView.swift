...
//        let view1Images = [#imageLiteral(resourceName: "icMorningBlack"),#imageLiteral(resourceName: "icAfternoonBlack"),#imageLiteral(resourceName: "icNightBlack")]
        ...
        let view1Images = [UIImage(named: "a"),UIImage(named: "a"),UIImage(named: "a")]
        let view1Strings = ["아침약 복용","점심약 복용","저녁약 복용"]
        for i in 0..<3 {
            let imageV1 = UIImageView(image: view1Images[i])
            imageV1.frame.origin.x = CGFloat(i) * 90
            imageV1.frame.size = CGSize(width: imageV1.frame.size.width * 1.1, height: imageV1.frame.size.height * 1.1)
            ...
            label1.sizeToFit()
            label1.frame.origin.x = imageV1.frame.maxX + 5
        ...
        let view2Images = [UIImage(named: "a"), UIImage(named: "a")]
