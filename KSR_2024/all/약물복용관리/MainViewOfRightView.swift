    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if dataDic[MainViewOfRightViewData.KEY_ARRAY] == nil {
            ...
            if self.selectedIndex == section {
                headerView.imageView.image = #imageLiteral(resourceName: "btn_unfold2").withRenderingMode(UIImageRenderingMode.alwaysTemplate)
            }else{
                headerView.imageView.image = #imageLiteral(resourceName: "btn_fold2").withRenderingMode(UIImageRenderingMode.alwaysTemplate)
            }
        }
...
//            print("기존 접기 & 새거 펼치기")
            ...
            if afterIndexPaths.count >= 1 {
                ...
                headerView2.imageView.image = #imageLiteral(resourceName: "btn_unfold2").withRenderingMode(UIImageRenderingMode.alwaysTemplate)
            }
            self.tableView.beginUpdates()
