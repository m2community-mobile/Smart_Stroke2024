...
//        topBar.leftImageView.image = #imageLiteral(resourceName: "sun2").withRenderingMode(.alwaysTemplate)
...
//        topBar.rightImageView2?.image = #imageLiteral(resourceName: "calendarX")
