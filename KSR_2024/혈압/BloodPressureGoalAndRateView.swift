//
//  BloodPressureGoalAndRateView.swift
//  KSR
//
...
class BloodPressureGoalAndRateView: UIView {
    
    var goalView : InnerViewWith2Value!
    var rateView : InnerViewWith2Value!
   
    convenience init() {
        self.init(frame: CGRect(origin: CGPoint.zero, size: CGSize(width: SCREEN.WIDTH, height: 145)))
    }
    ...
    private override init(frame: CGRect) {
        ...
        self.goalView = InnerViewWith2Value(frame:CGRect(
            x: 0,
            y: 0,
        ...
        self.rateView = InnerViewWith2Value(frame: CGRect(
            x: SCREEN.WIDTH * 0.53,
            y: 0,
