//
//  DyslipidemiaManagementTest.swift
//  KSR_2024
//
//  Created by m2comm on 2024/01/24.
//
//
import Foundation
//import UIKit
//
//class DyslipidemiaManagement: UIViewController {
//
...
class DyslipidemiaManagementTest: UIScrollView {
...
//                            ["total": "50", "ldl": "50", "hdl": "50", "mid": "50", "datetime": "2018.06.28 오후 03:29"]
                            ...
                            let graphValuesOfMin = [GraphData].self
                            for i in 0..<jsonArray.count {
