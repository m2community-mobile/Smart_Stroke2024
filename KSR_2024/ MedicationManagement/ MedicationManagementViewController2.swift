//
//   MedicationManagementViewController2.swift
//  KSR_2024
//
...
class   MedicationManagementViewController2: BaseViewController, RegisterdDrugListTopViewDelegate {
...
//        titleName.text = titleLabel
        ...
        self.MedicationManagementWebView = WebView(frame: CGRect(
            ...
            width: SCREEN.WIDTH,
            height: SCREEN.HEIGHT - menuView.frame.maxY), urlString: "http://ksrapp.m2comm.co.kr/info/info02_2a.php")
...
//        ObesityManagementNotebookView.bmiGraphVIew.layer.cornerRadius = 8
        ...
        MedicationManagementNotebookView.MedicationManagementViewIcon = UIImageView(frame: CGRect(x: self.view.frame.size.width / 2.4, y: 0, width: 100, height: 100))
...
//        underNumLabel.layer.borderWidth = 1
        ...
        MedicationManagementNotebookView.MedicationManagementBTN = UIButton(frame: CGRect(x: 20, y: underNumLabel.frame.maxY + 10, width: self.view.frame.size.width - 40, height: self.view.frame.size.height / 10))
